...
**Implemtation Plan**: The implementation plans are stored in /dev_docs/implementation/ - Keep these up to date, never modify the input or outputs as other services may rely on what we have previously decided on - if these will not work explicitly ask me to change
...
- Always keep the plan detailed and simple in a form a junior developer could pick up the project at any time and know what to do
</CLARIFICATION>
